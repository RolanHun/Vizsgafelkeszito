...
public class iranyitottGui extends javax.swing.JFrame {
    ...
    public static void main(String args[]) throws IOException {
        List<String > s = Files.readAllLines(Paths.get("emberek.txt"));
                
        ArrayList<String> dolgozokList = new ArrayList<>();
        for (String sor : s) {
            dolgozokList.add(new Dolgozo(sor).getNev());
        }       
        System.out.println(dolgozokList);
